...
var $author$project$PhotoGroove$thumbnails = _List_fromArray(
	[
		{url: '1.jpeg'},
		{url: '2.jpeg'},
		{url: '3.jpeg'}
...
var $author$project$PhotoGroove$viewThumbnailCols = function (thumbs) {
	...
	return A2(
		...
		A2(
			$elm$core$List$map,
			A2($elm$core$Basics$composeR, $author$project$PhotoGroove$viewThumbnail, column),
			thumbs));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$core$List$map,
							$author$project$PhotoGroove$viewThumbnailCols,
							A2($elm_community$list_extra$List$Extra$greedyGroupsOf, 2, model)))
					]))
			]));
};
var $author$project$PhotoGroove$main = $author$project$PhotoGroove$view($author$project$PhotoGroove$thumbnails);
